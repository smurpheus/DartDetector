...
\label{sec:basics}
Im folgenden werden einige Grundlagen beschrieben, die nötig sind um die verwendeten Algorithmen und Vorgehen nachvollziehen zu können. 

Beginnend bei der Entstehung der Verarbeiteten Bilder. Zur Vereinfachung wird vorerst von dem sogenannten "`Pinhole Camera Model"' ausgegangen. In Abbildung \prettyref{Fig:simple-pinhole} ist ein solches Modell zu sehen. 
...
Die Distanz zwischen I und der Barriere (f) ist bei heutigen Kameras die Focal Length. Hierbei gilt es zu bemerken, dass heute Kamera natürlich nicht mehr nur ein Loch besitzen, sondern eine Linse eingesetzt ist, die die Lichtstrahlen auf die Image Plane bündeln. Das grundlegende Modell bleibt aber bestehen. Darauf, wie die Linse das Bild verändert wird später eingegangen. 

Auf diese Weise entsteht eine Abbildung des Punktes P auf der zwei dimensionalen Fläche I. 

\begin{figure}
\includegraphics[width=\textwidth]{media/simple-pinhole}\\
